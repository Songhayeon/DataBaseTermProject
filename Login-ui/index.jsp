...
<body>
	...
	<div id="body">
		<div id="tagline">
			<h1>Delivery</h1>
			<p>For Better Delivery &amp; Easy to Use</p>
		</div>
		...
		<div id="login">
			...
			<input type="submit" style=font-size:15pt; height:25; value="login" /> 
			<input type="button" style=font-size:15pt; height:25; onclick="goSubmit()" value="register">
